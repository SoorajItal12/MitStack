             ...
             new Row(
              ...
              children: <Widget>[
                new IconButton(
                  icon: Icon(
                    Icons.home,
                    color: (ind==0)?Colors.red : Colors.white,
                  ),
                ...
                new IconButton(
                  icon: Icon(
                    Icons.search,
                    color: (ind==1)?Colors.red : Colors.white,
                  ),
                ...
                new IconButton(
                  icon: Icon(
                    Icons.add_box,
                    color: (ind==2)?Colors.red : Colors.white,
                  ),
                ...
                new IconButton(
                  icon: Icon(
                    Icons.favorite,
                    color: (ind==3)?Colors.red : Colors.white,
                  ),
                ...
                new IconButton(
                  icon: Icon(
                    Icons.account_box,
                    color: (ind==4)?Colors.red : Colors.white,
                  ),
